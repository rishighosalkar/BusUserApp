...
import com.example.bususerapp.Classes.Upload;
...
public class PostActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        route = intent.getStringExtra(LostFoundMainActivity.POST_ROUTE);
    ...
    public void onClick(View view) {
        if (view == buttonPost){
            ...
            onPost();
            finish();
            startActivity(new Intent(this, LostFoundMainActivity.class));
        }
